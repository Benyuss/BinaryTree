...
public class LZWBinaryTreeTest {
    ...
    public void testDepth() {
        ...
        // /
        // 0
        String[] temparray = tree.depth(TraversConst.INFIX);
        int depth = Integer.parseInt(temparray[1]);
    ...
    public void traversedDifference() {
        ...
        String[] temparray2 = tree.depth(TraversConst.INFIX);
        int depthAffected = Integer.parseInt(temparray[1]);
